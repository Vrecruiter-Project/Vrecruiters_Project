...
const getDesignTokens = (mode) => ({
  palette: {
    ...
    background: {
      default: "hsl(0, 0%, 100%)",
      paper: gray[100],
      paperfade: "hsla(20, 35%, 94%,.8)",
      ...(mode === "dark" && {
        default: "hsl(20, 30%, 3%)",
        paper: gray[900],
        paperfade: "hsla(20, 25%, 10%,.6)",
      }),
    },
    text: {
      primary: gray[900],
  ...
  typography: {
    fontFamily: ["Combo", "system-ui"].join(","),
    h1: {
    ...
    components: {
      ...
      MuiOutlinedInput: {
        styleOverrides: {
          ...
          root: ({ theme }) => ({
            ...
            boxShadow: "0 0 0 1.5px hsla(29, 0%, 0%, 0.02) inset",
            transition: "border-color 179ms ease-in",
            ...
            ...theme.applyStyles("dark", {
              ...
              borderColor: alpha(gray[700], 0.5),
              boxShadow: "0 0 0 1.5px hsl(29, 0%, 0%) inset",
      ...
      MuiSwitch: {
        styleOverrides: {
          root: ({ theme }) => ({
            ...
            "& .MuiSwitch-thumb": {
              boxShadow: "0 0 2px 2px hsla(20, 0%, 0%, 0.2)",
              backgroundColor: "hsl(0, 0%, 100%)",
              width: 16,
              height: 16,
              margin: 2,
      ...
      MuiToggleButtonGroup: {
        styleOverrides: {
          root: ({ theme }) => ({
            borderRadius: theme.shape.borderRadius,
            boxShadow: `0 1px 2px hsla(29, 0%, 0%, 0.05), 0 2px 12px ${alpha(
              brand[200],
              0.5
            )}`,
            "& .Mui-selected": {
            ...
            ...theme.applyStyles("dark", {
              ...
              boxShadow: `0 0 0 1px hsla(29, 0%, 0%, 0.5), 0 2px 12px ${alpha(
                brand[700],
                0.5
              )}`,
            }),
